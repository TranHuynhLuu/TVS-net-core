...
namespace ThuVienSo_Project.Helpper
{
    public static class Utilities
    {
        ...
        public static async Task<string> UploadTaiLieu(Microsoft.AspNetCore.Http.IFormFile file, string sDirectory, string newname = null)
        {
            try
            {
                if (newname == null) newname = file.FileName;
                string path = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot", "tailieu", sDirectory);
                CreateIfMissing(path);
                string pathFile = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot", "tailieu", sDirectory, newname);
